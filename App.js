  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.greeting}>Hello, I'm TIEN DUNG PHAM !</Text>
        <Text style={styles.info}>Student ID: n01718811</Text>
...
const styles = StyleSheet.create({
  ...
  info: { fontSize: 16, color: '#7f8c8d', textAlign: 'center', marginBottom: 5 },
  ...
  goal: { fontSize: 16, color: '#34495e', marginBottom: 5, lineHeight: 22 },
});
